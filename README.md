...
Desenvolvedora Front-End focada em criar interfaces digitais claras, funcionais e eficientes. Busco transformar ideias em experiências digitais que sejam intuitivas e acessíveis para todos os usuários.

💡 Estou em transição de carreira para a área de tecnologia, trazendo comigo uma sólida **experiência administrativa** que fortalece meu trabalho como desenvolvedora, com habilidades como atenção aos detalhes, organização, capacidade de resolver problemas e visão de processos. Essa bagagem me ajuda a construir **interfaces bem estruturadas e eficientes**, mantendo o foco em resultados práticos.
