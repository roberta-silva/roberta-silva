...
Venho do setor administrativo e trouxe comigo habilidades que fazem diferença no desenvolvimento: atenção aos detalhes, visão de processos, organização e foco em resultados. Hoje aplico esse olhar na construção de soluções web funcionais - da interface à lógica por trás dela.
